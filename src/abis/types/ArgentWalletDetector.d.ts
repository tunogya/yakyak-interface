...
export type ImplementationAddedEvent = TypedEvent<[string] & { implementation: string }>
...
export class ArgentWalletDetector extends BaseContract {
  ...
  filters: {
    "CodeAdded(bytes32)"(code?: BytesLike | null): TypedEventFilter<[string], { code: string }>
    ...
    "OwnerChanged(address)"(_newOwner?: string | null): TypedEventFilter<[string], { _newOwner: string }>
